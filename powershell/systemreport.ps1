...
# This was changed, but very little, to work as a module in Module200508880.psm1.
# As far as I can remember, the only change was to point getnet.ps1 to the module function
#   getnet, which is now also present in Module200508880.psm1.
