...
# With hash notation:
get-ciminstance Win32_NetworkAdapterConfiguration | ? ipenabled -eq $true | select Description, Index, @{n="IPv4Address"; e={$_.IPAddress[0]}}, @{n="IPv6Address"; e={$_.IPAddress[1]}}, @{n="Subnet"; e={$_.IPSubnet[0]}}, DNSDomain, @{n="DNSServer"; e={$_.DNSServerSearchOrder[0]}}